                    ...
                    page.includeJs('http://ajax.googleapis.com/ajax/libs/jquery/1.7.2/jquery.min.js', function (err, jquery) {
                        setTimeout(function () {
                            page.evaluate(function () {
                                ...
                                page.render(path_1.join(__dirname, 'google.png'), { format: 'png', quality: 100 }, function (err, status) {
                                    var _image = fs_1.readFile(path_1.join(__dirname, 'google.png'), function (err, data) {
                                        if (err) {
                                            throw err;
                                        }
